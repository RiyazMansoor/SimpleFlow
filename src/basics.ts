...
export namespace OceanFlow {
     ...
     */
    export abstract class Entity<IdT, DataT extends {}> implements d.Entity<IdT, DataT> {
    ...
    export abstract class SavableEntity<IdT, DataT extends {}>
        extends Entity<IdT, DataT> implements d.SavableEntity<IdT, DataT> {
        ...
        freeze(yes: boolean): void {
            if (yes) {
                Object.freeze(this.getDataT());
            };
        }

        save(): void {
            SavableEntity.saveData(this.fsdb, this.getIdT(), this.getDataT());
        }
     ...
     */
    export abstract class ConfigBase<ConfigT extends {}> extends Entity<t.NameT, ConfigT> {
     ...
     * <DataT> is the json data object
     */
    export abstract class SecureConfigBase<DataT extends t.SecureRoleT> extends ConfigBase<DataT> {
    ...
    export function hasRoles<IdT, DataT extends {}>(securable: d.Securable<IdT, DataT>): t.NameT[] {
        return securable.getDataT()[t.RoleNamesProperty];
    }

    export function hasAccess<IdT, DataT extends {}>
        (accessing: d.Securable<IdT, DataT>, credential: s.Credential): t.AuditCauseT[] {
